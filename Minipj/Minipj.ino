...
void handleNewMessages(int numNewMessages)
{
  ...
  for (int i = 0; i < numNewMessages; i++)
  {
    ...
    if (text == "/1"){
       ...
       x = RAD_TO_DEG * (atan2(-yAng, -zAng) + PI); y = RAD_TO_DEG * (atan2(-xAng, -zAng) + PI); z = RAD_TO_DEG * (atan2(-yAng, -xAng) + PI);
        ...
        if (text == "/end")
    {
      String end1 = "WELCOME TO GYM TRAINING SYSTEM  1:ARM EXCERCISE 2:LEG EXCERCISE";
      bot.sendMessage(chat_id, end1);
      break;
    }
             } 
 ...
 if (text == "/start")
    {
      String welcome = "WELCOME TO GYM TRAINING SYSTEM  1:ARM EXCERCISE 2:LEG EXCERCISE";
